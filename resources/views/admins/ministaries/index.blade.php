...
<div class="page-head">
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <span class="active"> جدول الوزارات</span>
        </li>
    </ul>
    <!-- END PAGE BREADCRUMB -->
                ...
                <div class="table-container">
                        ...
                        <thead>
                            <tr>
                                ...
                                <tbody>
                                    @foreach($ministaries as $ministary)
                                    <tr>
                                    <td>{{$ministary->id}}</td>
                                    <td>{{$ministary->name}}</td>
                                    <td> <img src="{{Storage::url($ministary->logo)}}"  height="40" width="40" alt=""></td>
                                    <td>
                                        <form action="{{route('ministaries.destroy', $ministary->id)}}" method="POST">
                                            @csrf {{ method_field('DELETE') }}
                                            <a href="{{route('ministaries.edit', $ministary->id)}}"
            ...
            <div class="modal fade" id="add-admin" tabindex="-1" role="basic" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="portlet-body form">
                            <form class="form-horizontal" id="level-form" role="form" method="POST" action="{{route('ministaries.store')}}" enctype="multipart/form-data">
                             @csrf
                            <div class="form-body">
